...
object NetworkModule {
    ...
    // Placeholder base URL - not strictly needed as we pass the full URL dynamically
    ...
    fun provideHttpLoggingInterceptor(): HttpLoggingInterceptor {
        return HttpLoggingInterceptor().apply {
            level = HttpLoggingInterceptor.Level.BODY // Log bodies for debugging
        }
    }
    ...
    @Provides
    @Singleton
    fun provideKeycloakApiService(retrofit: Retrofit): KeycloakApiService {
